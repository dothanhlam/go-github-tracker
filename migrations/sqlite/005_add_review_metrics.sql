-- Add review metrics columns to pr_metrics table
ALTER TABLE pr_metrics ADD COLUMN first_review_at DATETIME;
...
ALTER TABLE pr_metrics ADD COLUMN reviewers_list TEXT; -- JSON array of reviewer usernames
